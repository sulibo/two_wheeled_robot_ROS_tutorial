...
def clbk_laser(msg):
    ...
    dist_max = 10
    regions_ = {
        'right':  min(min(msg.ranges[0:144]), dist_max),
        'fright': min(min(msg.ranges[144:288]), dist_max),
        'front':  min(min(msg.ranges[288:432]), dist_max),
        'fleft':  min(min(msg.ranges[432:576]), dist_max),
        'left':   min(min(msg.ranges[576:720]), dist_max),
    }
